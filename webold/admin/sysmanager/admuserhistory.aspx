<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admuserhistory.aspx.cs" Inherits="admin_sysmanager_admuserhistory" %>
...
<script language="javascript" type="text/javascript">
    function CreateGrid(objs) {
        ...
        $('#tt').datagrid({
            url: '../../api/adm/admuserhistory.aspx?act=getlogin&id=<%=Id %>&stime='+sTime+'&etime='+eTime,
            singleSelect: true,
            fit: true,
            fitColumns: true,
            columns: [[
            { field: 'Ld', title: '编号', width: 50 },
            {fieId:'UId',title:'用户编号',width:100},
