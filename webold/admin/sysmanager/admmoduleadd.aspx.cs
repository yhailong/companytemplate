...
public partial class admin_sysmanager_admmoduleadd : baseCC
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            CFun.BindListControl<TrueOrFalse>(RblIsSysMenu,false);
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        ...
        if (new BllAdmUserModule().InsertorUpdateitem(cont))
        {
