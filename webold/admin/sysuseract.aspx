<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sysuseract.aspx.cs" Inherits="syscc_sysuseract" %>
...
<script language="javascript" type="text/javascript">
    function CreateGrid(objs) {
        ...
        $('#tt').datagrid({
            url: '../aspx/cc/sysuserhistory.aspx?act=getact&id=<%=Id %>&stime=' + sTime + '&etime=' + eTime+'&actclass='+$C("DdlAct").value,
            singleSelect: true,
            fit: true,
            fitColumns: true,
            columns: [[
