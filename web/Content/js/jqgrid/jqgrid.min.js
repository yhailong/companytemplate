    ...
    $.fn.jqGrid = function (pin) {
        ...
        return this.each(function () {
            ...
            addJSONData = function (data, rcnt, more, adjust) {
                ...
                ts.p.lastpage = (Math.ceil(parseInt($.jgrid.getAccessor(data, dReader.total)) / parseInt(ts.p.rowNum)));// intNum($.jgrid.getAccessor(data, dReader.total), 1);
            ...
            if (this.p.rownumbers) {
                ...
                this.p.colModel.unshift({ name: 'rn', width: ts.p.rownumWidth+"px", sortable: false, resizable: false, hidedlg: true, search: false, align: 'center', fixed: true, frozen: true });
            }
            ...
            firstr = null;
            var hTable = $("<table " + getstyle(stylemodule, 'headerTable', false, 'ui-jqgrid-htable ui-common-table') + " style='width:100%' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(thead),
            ...
            $("table:first", grid.bDiv).css({ width: "100%" });
            if (!$.support.tbody) { //IE
