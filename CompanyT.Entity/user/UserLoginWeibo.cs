...
{
    #region UserLoginWeibo
    /// <summary>
    /// 
    /// </summary>
    [DataFieldAttribute("UserLoginWeibo")]
    [DataContract]
    public class UserLoginWeibo
   {
        ...
        #region 公共属性 
         ...
         /// 微博昵称
         /// </summary>
         [DataFieldAttribute("WBNiceName")]
         [DataMember]
         public string WBNiceName
         {
             get ;
             set ;
         }
