...
{
    /// <summary>
    /// CompanyNewsClass 的数据库方法
    /// </summary>
    public class BllCompanyNewsClass :Bll_Base<CompanyNewsClass,Sql_CompanyNewsClass>
    {
       ...
       /// 
       /// </summary>
       public BllCompanyNewsClass() : base() { }
       
       /// <summary>
       /// 
       /// </summary>
       /// <param name="sqlConn">数据库连接名</param>
       public BllCompanyNewsClass(string sqlConn) : base(sqlConn) { }
       #endregion 
