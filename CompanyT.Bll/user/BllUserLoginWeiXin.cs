...
{
    /// <summary>
    /// UserLoginWeiXin 的数据库方法
    /// </summary>
    public class BllUserLoginWeiXin :Bll_Base<UserLoginWeiXin,Sql_UserLoginWeiXin>
    {
       ...
       /// 
       /// </summary>
       public BllUserLoginWeiXin() : base() { }
       
       /// <summary>
       /// 
       /// </summary>
       /// <param name="sqlConn">数据库连接名</param>
       public BllUserLoginWeiXin(string sqlConn) : base(sqlConn) { }
       #endregion 
